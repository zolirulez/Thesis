...
hValues = [450 ...
    CoolProp.PropsSI('H','P',pValues(2),'T',273.15+30+4,'CO2')/1000 ...
    CoolProp.PropsSI('H','P',pValues(3),'Q',0,'CO2')/1000 ...
    CoolProp.PropsSI('H','P',pValues(3),'Q',1,'CO2')/1000 ...
    280 525 ...
    (525*DmValues(5)+460*DmValues(2))/DmValues(1)]*10^3; % h1 h2 hL hG hR hMT hHR
hBPValue = 298*10^3;
delta_hValues = [0 hValues(2)-hBPValue]; % delta_hHR delta_h2
...
CRValues = [0 0.25 0.25 0.45]; % BP CRV CRA CRIT
fValues = 48; % MxfIT
...
for it = 1:numel(fields)
    ...
    mx4sub.(fields{it}) = subs(mx4sub.(fields{it}),{delta_hHR delta_h2},num2cell(delta_hValues));
