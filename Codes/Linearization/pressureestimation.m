...
for it1 = 1:division-1
    for it2 = 1:division-1
...
maxerrorT
figure(1)
surf(1:division-1,1:division-1,squeeze(paramvectorP(1,:,:)))
figure(2)
surf(1:division-1,1:division-1,squeeze(paramvectorP(2,:,:)))
figure(3)
surf(1:division-1,1:division-1,squeeze(paramvectorT(1,:,:)))
figure(4)
surf(1:division-1,1:division-1,squeeze(paramvectorT(2,:,:)))
% plot(y-X*param)