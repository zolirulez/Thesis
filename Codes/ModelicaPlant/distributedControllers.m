...
PI_GC.initialize(K,Ti,initialIntegration,minOutput,maxOutput,negation,Ts)
...
PI_MT.initialize(K,Ti,initialIntegration,minOutput,maxOutput,negation,Ts)
...
PI_LT.initialize(K,Ti,initialIntegration,minOutput,maxOutput,negation,Ts)
...
K = 1e-4;
initialIntegration = 0.3;
PI_RP.initialize(K,Ti,initialIntegration,minOutput,maxOutput,negation,Ts)
...
PI_BP.initialize(K,Ti,initialIntegration,minOutput,maxOutput,negation,Ts)
...
PI_C.initialize(K,Ti,initialIntegration,minOutput,maxOutput,negation,Ts)
...
PI_F.initialize(K,Ti,initialIntegration,minOutput,maxOutput,negation,Ts)
