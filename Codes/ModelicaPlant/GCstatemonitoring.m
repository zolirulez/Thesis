...
clearvars
addpath('matfiles')
load h1_sim_faultcontrol2 %h1_faulty_chirp % h1_sim_faulty
...
load h1_sim_faultcontrol2 % h1_sim_faulty % h1_faulty_chirp
Y = h1_sim.signals.values;
figure(3)
subplot(211)
...
load uy_sim_faultcontrol2 % uy_sim_faulty % uy_sim_faulty_chirp
...
tfest(iddata0,2)
tfest(iddata0,3)
save('TGC_faultcontrol2','Tcw','hcw')%save('TGC_faultyestctrl')